...
export default function Quiz() {
  ...
  const getName = async function () {
    const pokemonData = await axios.get(
      "https://pokedictionarygamedev.onrender.com/GetAllPokemon"
    );
    ...
    <>
      {!quizResultsSent ? (
        <>
            ...
            {singlePokeData ? (
              <>
                <button
                  ...
                  id="button1"
                  key="first"
                  onClick={() => handleClick(englishNames[0].id)}
                >
                ...
                <button
                  ...
                  id="button2"
                  key="second"
                  onClick={() => handleClick(englishNames[1].id)}
                >
                ...
                <button
                  ...
                  id="button3"
                  key="third"
                  onClick={() => handleClick(englishNames[2].id)}
                >
                ...
                <button
                  ...
                  id="button4"
                  key="fourth"
                  onClick={() => handleClick(englishNames[3].id)}
                >
          ...
          <br />
          <Link to="/home">
            <button className="language">Give Up?</button>
          </Link>
          {answer ? (
            <>
