...
export default function QuizEtoItalian() {
    //State Variables
    ...
    return (
        ...
        <div className='question-card'>
            ...
            {singlePokeData?
            <>
                <button className='language' id='button1' key="first" onClick={() => handleClick(names[0].id)}>{names[0].nameItalian}</button>
                <button className='language' id='button2' key="second" onClick={() => handleClick(names[1].id)}>{names[1].nameItalian}</button>
