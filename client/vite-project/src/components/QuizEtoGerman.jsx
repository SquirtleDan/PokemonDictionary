...
export default function QuizEtoGerman() {
    //State Variables
    ...
    return (
        ...
        <div className='question-card'>
            ...
            {singlePokeData?
            <>
                <button className='language' id='button1' key="first" onClick={() => handleClick(names[0].id)}>{names[0].nameGerman}</button>
                <button className='language' id='button2' key="second" onClick={() => handleClick(names[1].id)}>{names[1].nameGerman}</button>
                <button className='language' id='button3' key="third" onClick={() => handleClick(names[2].id)}>{names[2].nameGerman}</button>
                <button className='language' id='button4' key="fourth" onClick={() => handleClick(names[3].id)}>{names[3].nameGerman}</button>
                <br/>
